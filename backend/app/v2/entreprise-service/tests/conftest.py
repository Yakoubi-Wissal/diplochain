...
from routers.entreprises import get_db as entreprises_get_db

# Use a persistent file for SQLite
TEST_DB_FILE = "./test_entreprises.db"
...
app.dependency_overrides[entreprises_get_db] = override_get_db
