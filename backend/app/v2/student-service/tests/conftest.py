...
async def setup_db():
    ...
    # Cleanup
    db_file = "./test_student_service.db"
...
# Also override the one in the router if it was imported differently
import routers.students
app.dependency_overrides[routers.students.get_db] = override_get_db
